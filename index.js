...
//  Create embedded signing view (for Supervisor)
const viewRequest = {
  returnUrl: 'https://docusign-oauth-launch.onrender.com/done', // Adjust this as needed
  authenticationMethod: 'none',
  email: 'sdtdsign+iam@gmail.com', // Must match email in templateRoles
  userName: 'Scott Docusign',
  clientUserId: '1001', // Must match clientUserId in templateRoles
};
